...
const MORNING_WALK_TITLE = IS_CHINESE ? '清晨健走' : 'Morning Walk';
const MIDDAY_WALK_TITLE = IS_CHINESE ? '午间健走' : 'Midday Walk';
const AFTERNOON_WALK_TITLE = IS_CHINESE ? '午后健走' : 'Afternoon Walk';
const EVENING_WALK_TITLE = IS_CHINESE ? '傍晚健走' : 'Evening Walk';
const NIGHT_WALK_TITLE = IS_CHINESE ? '夜晚健走' : 'Night Walk';
...
const HIKE_TITLES = {
  MORNING: MORNING_HIKE_TITLE,
  MIDDAY: MIDDAY_HIKE_TITLE,
  AFTERNOON: AFTERNOON_HIKE_TITLE,
  EVENING: EVENING_HIKE_TITLE,
  NIGHT: NIGHT_HIKE_TITLE,
};
const WALK_TITLES = {
  MORNING: MORNING_WALK_TITLE,
  MIDDAY: MIDDAY_WALK_TITLE,
  AFTERNOON: AFTERNOON_WALK_TITLE,
  EVENING: EVENING_WALK_TITLE,
  NIGHT: NIGHT_WALK_TITLE,
};
