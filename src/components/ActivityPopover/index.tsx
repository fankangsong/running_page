...
export { ActivityPopoverProvider, useActivityPopover } from './ActivityPopoverContext';
...
export const ActivityPopover = () => {
  ...
  return createPortal(
    <div
      ...
      style={style}
    >
      <div className={`w-[${POPOVER_WIDTH}px] rounded-xl border border-white/10 bg-gray-900/95 backdrop-blur-md p-3 shadow-2xl shadow-black/50`}>
        {/* Header Section */}
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center gap-1 text-[10px] text-gray-500 font-bold tracking-wider uppercase">
              <span className="text-emerald-500"><DistanceIcon /></span>
              KM
            </div>
          ...
          <div className="flex flex-col gap-0.5 border-l border-white/5 pl-2">
            <div className="flex items-center gap-1 text-[10px] text-gray-500 font-bold tracking-wider uppercase">
              <span className="text-blue-500"><PaceIcon /></span>
              Pace
            </div>
          ...
          <div className="flex flex-col gap-0.5 border-l border-white/5 pl-2">
            <div className="flex items-center gap-1 text-[10px] text-gray-500 font-bold tracking-wider uppercase">
              <span className="text-amber-500"><TimeIcon /></span>
              Time
            </div>
          ...
          <div className="flex flex-col gap-0.5 border-l border-white/5 pl-2">
            <div className="flex items-center gap-1 text-[10px] text-gray-500 font-bold tracking-wider uppercase">
              <span className="text-rose-500"><HeartRateIcon /></span>
              BPM
            </div>
        ...
        {/* Achievement Badge */}
        {achievement && (
          <div className={`mt-3 pt-2 border-t border-white/10 flex items-center gap-2 ${achievement.colorClass}`}>
