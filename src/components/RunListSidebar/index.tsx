...
const RunListSidebar: React.FC<RunListSidebarProps> = ({
  ...
  const handlePrevMonth = () => {
    // Prev means moving backward in time (older month) -> higher index
  ...
  const handleNextMonth = () => {
    // Next means moving forward in time (newer month) -> lower index
  ...
  return (
    <div className={`pointer-events-auto bg-card/90 backdrop-blur-xl rounded-card shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-800/50 flex flex-col transition-all overflow-hidden relative ${isExpanded ? 'w-full md:w-80 md:max-h-[50vh] lg:max-h-[calc(100vh-120px)]' : 'w-auto'}`}>
        ...
        <div className="flex justify-center items-center">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="ml-2 p-1 rounded hover:bg-gray-800 transition-all"
